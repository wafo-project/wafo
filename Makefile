...
help:
	...
	@echo "------------------------------------------------------------------"
	@echo "  install            to add Wafo to the Matlab and GNU Octave"
	@echo "                     search paths, using whichever is present"
	@echo "  uninstall          to remove Wafo from the Matlab and GNU"
	...
	@echo ""
	@echo "  install-matlab     to add Wafo to the Matlab search path"
	@echo "  install-octave     to add Wafo to the GNU Octave search path"
	@echo "  uninstall-matlab   to remove Wafo from the Matlab search path"
	@echo "  uninstall-octave   to remove Wafo from the GNU Octave search"
	@echo "                     path"
...
RUNTESTS_ARGS='${TESTDIR}', '-recursive'
ifdef JUNIT_XML
