function test_suite=test_scalespec()
  initTestSuite;
end
function test_scalespec_()
   ...
   assert(spec2char(Sn,{'Hm0','Tm02','Ss'}),... 
       [ 12.0003689455427818, 9.9702039670038527, 0.0773502064191521], 1e-4)
end
