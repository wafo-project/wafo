...
! International Statistical Review, Vol 59, 2, pp 195--225
	...
	END MODULE SIZEMOD
      ...
      DOUBLE PRECISION :: CEPSS=0.99995d0 ! accuracy of Indicator 
...
C
 ...
 2      CONTINUE
      ...
      iii01=iii01+1
      RETURN
 10   CALL RIND1(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii11=iii11+1
      RETURN
 20   CALL RIND2(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii21=iii21+1
      RETURN
 30   CALL RIND3(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii31=iii31+1
      RETURN
 40   CALL RIND4(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii41=iii41+1
      RETURN
 50   CALL RIND5(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii51=iii51+1
      RETURN
 60   CALL RIND6(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii61=iii61+1
      RETURN
 70   CALL RIND7(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii71=iii71+1
      RETURN
 80   CALL RIND8(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii81=iii81+1
      RETURN
 90   CALL RIND9(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii91=iii91+1
      RETURN
 100  CALL RIND10(XIND,R,BU,DBUN,DB,SQ,VDER,N)
      iii101=iii101+1
      RETURN
 99   continue   
      SDER=0.0d0
...
C     STOP
      ...
      Z1(J)=XX1(J)*XX1(J)
20    H1(J)=0.5d0*SP*(XMA-XMI)*H(NNN+J)*EXP(-0.5d0*Z1(J))
      NNN=NNN+N
...
100   IF(X.GT.0.0d0) PMEAN=SS*SP*EXP(-0.5d0*X*X)+XX*0.5d0*(Z+1.0d0)
...
!	INTEGER, PARAMETER :: MMAX = 5, NMAX = 101, RDIM = 10201
	...
	REAL*8  XIND, DB0N,FR1,VDER, XR1,XMI,XMA
	REAL*8  CC, PC, PD, P, X
