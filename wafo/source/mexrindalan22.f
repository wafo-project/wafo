...
!         Nt,SCIS,XcScale,ABSEPS,RELEPS,COVEPS,MAXPTS,MINPTS,seed,NIT,xCutOff);
!
!
...
C	DOUBLE PRECISION :: ABSEPS, RELEPS, VAL, ERR
      ...
      DOUBLE PRECISION, ALLOCATABLE :: ERR1(:), rINFI(:)
