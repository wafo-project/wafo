...
%HEX2INT8 Convert hexadecimal string to int8 type.
%   HEX2INT8(H) interprets the hexadecimal string H and returns the
%   equivalent int8 number.

%   Author:      Peter J. Acklam
%   Time-stamp:  1999-07-19 00:14:42
