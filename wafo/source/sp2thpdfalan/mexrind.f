...
* 
*  CALL: [value,error,inform]=mexrind(S,m,xc,Nt,Nj,NIT,speed,indI,Blo,Bup,seed);
*
*
...
C     
C     mex mexrind.f intmodule.f  jacobmod.f alanpab2.f 
C
C           
...
C
	...
	REAL*8  :: mxGetScalar
      INTEGER :: Nx,Nt,Nj,Nc,Ntd,Nd,Ntdc,Ni,Nb,Mb,K,I
C	DOUBLE PRECISION :: ABSEPS, RELEPS, VAL, ERR
      INTEGER :: speed1, seed1, NIT
...
C     Call the computational subroutine.
		CALL RINDD(VALS,Big,Ex,Xc,Nt,INDI,Blo,Bup,INFIN)
	ELSE
