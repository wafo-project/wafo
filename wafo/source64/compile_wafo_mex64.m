%% COMPILE_WAFO_MEX Script that compiles WAFO mexfiles for 32 and 64 bit platforms
%
...
%matlab prompt (note the extension .F for routines to be pre-processed by 
%compiler pre-processor, this has been tested by GL February 2011 on 64-bit.
%Hopefully it works also for 32-bit platfoems.
%:
