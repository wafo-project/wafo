function [value,error1,inform]=mexmvnprb2(correl,A,B,abseps,releps,maxpoints) 
%MEXMVNPRB2 Computes multivariate normal probability by Genz' algorithm
...
%
%  CALL: [value,error,inform] = mexmvnprb2(correl,A,B,abseps,releps,maxpoints);
%
...
disp('mexmvnprb2 is not implemented as a m-function')
disp('                   compile the mexfile mexmvnprb2.f before you try again.')
error('mexmvnprb2 error')
return
